...
env = environ.Env(
    ...
    PROJECT_PROGRAMME_EDITOR_AD_GROUPS=(list, []),
    PROJECT_PROGRAMME_REVERTER_AD_GROUPS=(list, []),
...
RESTRICTED_PROGRAMMER_AD_GROUP = env("RESTRICTED_PROGRAMMER_AD_GROUP")
PROJECT_PROGRAMME_EDITOR_AD_GROUPS = env.list("PROJECT_PROGRAMME_EDITOR_AD_GROUPS", default=[])
PROJECT_PROGRAMME_REVERTER_AD_GROUPS = env.list("PROJECT_PROGRAMME_REVERTER_AD_GROUPS", default=[])
