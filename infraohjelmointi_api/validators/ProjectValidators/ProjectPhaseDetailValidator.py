...
class ProjectPhaseDetailValidator(BaseValidator):
    """
    Validates that the selected phaseDetail belongs to the correct projectPhase.
    Replaces ConstructionPhaseDetailValidator with generalized logic.
    """
    ...
    def __call__(self, allFields, serializer) -> None:
        ...
        # Validate that the detail's projectPhase matches the selected phase
