...
class TalpaProjectType(models.Model):
    ...
    code = models.CharField(max_length=50, blank=False, null=False)  # e.g., "8 03 01 01"
    ...
    priority = models.CharField(max_length=20, blank=True, null=True)  # Letter code from PRIOR column: A, B, C, etc.
    description = models.TextField(blank=True, null=True)  # Talousarviokohta description, e.g., "Eteläinen suurpiiri"
