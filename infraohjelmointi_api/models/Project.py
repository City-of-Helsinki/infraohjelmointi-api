...
class Project(models.Model):
    ...
    pwGUID = models.UUIDField(editable=True, null=True, default=None, blank=True)
    ...
    @property
    def pw_folder(self):
        if self.pwGUID is not None:
            return "pw://HELS000601.helsinki1.hki.local:PWHKIKOUL/Documents/P{{{}}}/".format(
                self.pwGUID
            )
        return None
