...
def update_project_range_area_names(apps, schema_editor):
    ...
    for update in updates:
        ...
        for r in ranges:
            ...
            if r.area and update['old_area'] in r.area:
...
def reverse_update_project_range_area_names(apps, schema_editor):
    ...
    for reversal in reversals:
        ...
        for r in ranges:
            if r.area and r.area == reversal['old_area']:
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Add groupLabel field for UI dropdown grouping (e.g., "8 03 01 01 Katujen uudisrakentaminen")
        migrations.AddField(
        ...
        # Update area names for 2814E ranges
