...
class BalkSumTestCase(TestCase):
    ...
    def test_GET_class_with_sums(self):
        ...
        self.assertEqual(response.json()["finances"]["year0"]["plannedBudget"], 1800)
        self.assertEqual(response.json()["finances"]["year0"]["frameBudget"], 560)
        self.assertEqual(response.json()["finances"]["year1"]["frameBudget"], 300)
        self.assertEqual(response.json()["finances"]["year2"]["frameBudget"], 300)
        self.assertEqual(response.json()["finances"]["year3"]["frameBudget"], 60)
        self.assertEqual(response.json()["finances"]["year4"]["frameBudget"], 30)
        self.assertEqual(response.json()["finances"]["year5"]["frameBudget"], 5)
        self.assertEqual(response.json()["finances"]["year6"]["frameBudget"], 0)
        self.assertEqual(response.json()["finances"]["year7"]["frameBudget"], 25)
        self.assertEqual(response.json()["finances"]["year8"]["frameBudget"], 45)
        self.assertEqual(response.json()["finances"]["year9"]["frameBudget"], 50)
        ...
        self.assertEqual(response.json()["finances"]["year2"]["frameBudget"], 100)
        self.assertEqual(response.json()["finances"]["year3"]["frameBudget"], 20)
        self.assertEqual(response.json()["finances"]["year4"]["frameBudget"], 10)
        ...
        self.assertEqual(response.json()["finances"]["year0"]["plannedBudget"], 700)
        self.assertEqual(response.json()["finances"]["year0"]["frameBudget"], 260)
        self.assertEqual(response.json()["finances"]["year1"]["frameBudget"], 200)
        self.assertEqual(response.json()["finances"]["year2"]["frameBudget"], 200)
        self.assertEqual(response.json()["finances"]["year3"]["frameBudget"], 40)
        self.assertEqual(response.json()["finances"]["year4"]["frameBudget"], 20)
        self.assertEqual(response.json()["finances"]["year5"]["frameBudget"], 0)
        self.assertEqual(response.json()["finances"]["year6"]["frameBudget"], 0)
        self.assertEqual(response.json()["finances"]["year7"]["frameBudget"], 15)
        self.assertEqual(response.json()["finances"]["year8"]["frameBudget"], 27)
        self.assertEqual(response.json()["finances"]["year9"]["frameBudget"], 30)
        self.assertEqual(response.json()["finances"]["year10"]["frameBudget"], 0)
        ...
        self.assertEqual(response.json()["finances"]["year5"]["frameBudget"], 0)
        self.assertEqual(response.json()["finances"]["year6"]["frameBudget"], 0)
        self.assertEqual(response.json()["finances"]["year7"]["frameBudget"], 5)
        self.assertEqual(response.json()["finances"]["year8"]["frameBudget"], 9)
    ...
    def test_GET_group_with_sums(self):
        ...
        self.assertEqual(response.json()["finances"]["year1"]["frameBudget"], 150)
        self.assertEqual(response.json()["finances"]["year2"]["frameBudget"], 150)
        self.assertEqual(response.json()["finances"]["year3"]["frameBudget"], 30)
        self.assertEqual(response.json()["finances"]["year4"]["frameBudget"], 15)
        self.assertEqual(response.json()["finances"]["year5"]["frameBudget"], 0)
