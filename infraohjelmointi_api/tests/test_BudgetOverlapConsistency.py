...
from infraohjelmointi_api.views import ProjectClassViewSet
...
class BudgetOverlapConsistencyTestCase(TestCase):
    ...
    def test_frame_budgets_context_is_provided(self):
        ...
        self.create_budget_scenario(parent_budget, child1_budget, child2_budget)
    ...
    def test_both_methods_give_same_result(self):
        ...
        parent_budget = 50000
        child1_budget = 30000  
        child2_budget = 28000  # Total: 58000 > 50000, should overlap
...
class ViewEndpointConsistencyTestCase(TestCase):
    ...
    def test_frame_budgets_context_provided(self):
        ...
        # Simplified test: verify that BaseClassLocationViewSet has been modified 
        # to include frame_budgets context building logic
        ...
        self.assertIn("ClassFinancial.objects.filter", list_method_source,
                     "BaseClassLocationViewSet.list should now query ClassFinancial for frame_budgets")
        self.assertIn("LocationFinancial.objects.filter", list_method_source,
                     "BaseClassLocationViewSet.list should now query LocationFinancial for frame_budgets")
        
        # This confirms our fix is in place
