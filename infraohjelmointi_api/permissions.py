...
PROJECT_NOTE_COORDINATOR_GET_ACTIONS = ["get_note_history", "get_note_history_by_user", "get_project_notes", "images",]
PROJECT_NOTE_PLANNING_GET_ACTIONS = ["get_note_history", "get_note_history_by_user", "get_project_notes", "images",]
PROJECT_NOTE_BASIC_ACTIONS = ["create", "images", "delete_image"]
